...
(0, _jquery2.default)('link#dark_mode-css').size() && (0, _jquery2.default)('body').addClass('aiot-wp-dark-mode');
...
exports.rmlOpts = exports.hooks = exports.addUrlParam = exports.fetchTree = exports.ICON_OBJ_FOLDER_GALLERY = exports.ICON_OBJ_FOLDER_COLLECTION = exports.ICON_OBJ_FOLDER_ROOT = exports.ICON_OBJ_FOLDER_CLOSED = exports.ICON_OBJ_FOLDER_OPEN = exports.trailingslashit = exports.untrailingslashit = undefined;
...
function ajax(url) {
    ...
    // WPML workaround (https://wpml.org/forums/topic/problems-with-rest-api-calls-from-backend-leading-to-fatal-error-with-gutenberg/)
    var wpmlMatcher = /lang=(.*)%2Findex\.php&/gm.exec(apiUrlRoot);
    var isWPMLBug = false;
    if (wpmlMatcher && wpmlMatcher.length > 1) {
        apiUrlRoot = apiUrlRoot.replace(/\?lang=(.*)%2Findex\.php&/gm, '/index.php?');
        lang = wpmlMatcher[1];
        isWPMLBug = true;
    }

    var apiUrl = apiUrlRoot.split('?')[0],
        restParams = apiUrlRoot.split('?')[1],
        ignoreRestParams = lang && !isWPMLBug || !restParams;
    var useUrl = trailingslashit(apiUrl + (ignoreRestParams ? '' : '?' + restParams)) + urlNamespace + '/' + url;
    ...
    if (WP_REST_API_USE_GLOBAL_METHOD && settings.method && settings.method.toUpperCase() !== 'GET') {
        useUrl = (0, _addUrlParam2.default)(useUrl, '_method', settings.method);
        settings.method = 'POST';
    }

    var promise = _jquery2.default.ajax(useUrl, _jquery2.default.extend(true, settings, {
        headers: {
